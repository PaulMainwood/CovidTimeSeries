...
ba4 <- read.csv("https://sars2.cvr.gla.ac.uk/cog-uk/session/7259368f6ff02dff15c2880a0787dbf8/download/downloadConcern?w=")
ba5 <- read.csv("https://sars2.cvr.gla.ac.uk/cog-uk/session/7259368f6ff02dff15c2880a0787dbf8/download/downloadConcern?w=")
#This one takes ages
ba2 <- read.csv("https://sars2.cvr.gla.ac.uk/cog-uk/session/7dd010c5c0ce6874fa970f96f49ede69/download/downloadConcern?w=")
...
ba4 <- fread("https://cog-uk.s3.climb.ac.uk/phylogenetics/latest/cog_metadata.csv.gz")
