...
plot(date(df$sample_date), log2(df$ba4_frac), col = 2, ylim = c(-13, 0), xlim = c(first_date, last_date), yaxt = "n", xaxt = "n", ylab = "Ratio of BA.4 to BA.2, % - log2 scale", xlab = "Date", main = "BA.4 as a proportion of COG-UK sequences")
